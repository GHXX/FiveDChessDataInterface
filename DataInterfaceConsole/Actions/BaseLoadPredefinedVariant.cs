...
internal abstract class BaseLoadPredefinedVariant : BaseAction {
    ...
    protected override void Run() {
        ...
        try {
            ...
            {
                at = this.di.TrapMainThreadForGameLoad();
            ...
            if (UseOnlineVariants && !GithubVariantGetter.IsCached)
                WriteLineIndented("Getting variants from github...");

            var variants = UseOnlineVariants ? GithubVariantGetter.GetAllVariants(false, false) : GithubVariantGetter.GetAllVariants(true, true);
